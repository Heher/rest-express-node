...
$(document).ready(function() {
    ...
    $('#userList table tbody').on('click', 'td a.linkupdateuser', changeUserForm);
...
function changeUserForm(event) {
    ...
    var updateHeader = $('#addUser').prev();
    updateHeader.html("Update User");
    ...
    // Change Add User button to Update User
    var updateButton = $('#addUser button');
    updateButton.html("Update User");

    // Change Add User button id to Update User
    updateButton.off();
    updateButton.attr('id', 'btnUpdateUser');
    updateButton.attr('rel', thisUserObject._id);
